...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{TG313}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \begin{figure}
      ...
      \attribcaption{TG313--TG318}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{TG311--TG312}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
    $2m$-FM Endstufe
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{TG222--TG225}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{TJ601}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
\end{frame}
...
\begin{center}
    \begin{figure}
      ...
      \attribcaption{TJ401}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
\end{frame}
\section*{Dummy-Load}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{figure}
      ...
      \attribcaption{``Cantenna'' für bis zu 1kW}{Gerry Ashton}{https://commons.wikimedia.org/wiki/File:Cantenna.JPG}{\ccbysa}
    \end{figure}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{Netzteil aus TD306}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
  Wie funzt das?
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{figure}
      ...
      \attribcaption{TD319}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
    \column{.45\textwidth}
    \begin{itemize}
...
\begin{frame}
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{Schaltnetzteil aus TD317}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
  \begin{itemize}
