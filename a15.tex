...
\begin{frame}{Analog-Digital-Wandlung (ADC)}
  \begin{columns}
    ...
    \begin{figure}
      ...
      \attribcaption{Übersicht kontinuierliche und diskrete Signale}{wdwd}{https://commons.wikimedia.org/wiki/File:Übersicht_kontinuierliche_und_diskrete_Signale.svg}{\ccby}
    \end{figure}
    \column{.45\textwidth}
