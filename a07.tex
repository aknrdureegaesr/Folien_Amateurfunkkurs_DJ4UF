...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{Frequenzgrenze eines OP-Verstärkers als Funktion der Verstärkung}{Herbertweidner}{https://commons.wikimedia.org/wiki/File:Closed_loop_gain.png}{\ccpd}
    \end{figure}
    \begin{itemize}
