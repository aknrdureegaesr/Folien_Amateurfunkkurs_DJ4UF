...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{Was ist das Vor-Rück Verhältnis, dBd und dBi}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      \includegraphics[width=1\textwidth,height=.75\textheight,keepaspectratio]{a09/W3DZZ.png}
      \attribcaption{TH134 -- Wenn man diese Mehrband-Antenne auf 3,5\,MHz erregt, dann wirken die LC-Resonanzkreise wie?}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{TH130 -- Eindrehtspeiseleitung mit $500 \Omega$ Heutzutage kaum noch verwendet wegen zu vielen Umwelteinflüßen auf die Speiseleitung}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{10M Yagi bei DK\O TU}{DK9GD}{}{}
    \end{figure}
  \end{center}
\end{frame}
