...
\begin{frame}[allowframebreaks]
	...
	\begin{thebibliography}{10}
	  ...
	  \bibitem{s-meter}
	    By Cqdx (Own work),
	    \newblock{\CcGroupBySa{0.5}{2px} [CC BY-SA 3.0 (http://creativecommons.org/licenses/by-sa/3.0)]},
	    \newblock{via Wikimedia Commons},
	    \newblock{\url{https://commons.wikimedia.org/wiki/File:S-Meter.jpg}}
	  \bibitem{parallel}
	    von Twin-lead\_cable.svg: User:SpinningSpark, modified by Inductiveload derivative work: Wdwd (Diskussion) (Twin-lead\_cable.svg),
	    \newblock{\CcGroupBySa{0.5}{2px} [CC BY-SA 3.0 (http://creativecommons.org/licenses/by-sa/3.0)]},
	    \newblock{via Wikimedia Commons},
	    \newblock{\url{https://commons.wikimedia.org/wiki/File:Twin-lead_cable_dimension.svg}}
	  \bibitem{coax}
	    By Coaxial\_cable\_cutaway.svg: Tkgd2007 derivative work: Fleshgrinder (Coaxial\_cable\_cutaway.svg),
	    \newblock{\CcGroupBy{0.5}{2px} [CC BY 3.0 (http://creativecommons.org/licenses/by/3.0)]},
	    \newblock{via Wikimedia Commons},
	    \newblock{\url{https://commons.wikimedia.org/wiki/File:Coaxial_cable_cutaway_new.svg}}
	  \bibitem{hohl}
	    Averse aus der deutschsprachigen Wikipedia
	    \newblock{\CcGroupBySa{0.5}{2px} [CC BY-SA 2.0 de (http://creativecommons.org/licenses/by-sa/2.0/de/deed.en), GFDL (http://www.gnu.org/copyleft/fdl.html) oder CC-BY-SA-3.0 (http://creativecommons.org/licenses/by-sa/3.0/)]},
	    \newblock{via Wikimedia Commons},
	    \newblock{\url{https://commons.wikimedia.org/wiki/File:Elli_holl.jpg}}
	  \bibitem{anpassung}
	    von selbst vektorisiert (selbst vektorisiert),
	    \newblock{\CcGroupPd{0.5} [Public domain]}, 
	    \newblock{via Wikimedia Commons},
	    \newblock{\url{https://commons.wikimedia.org/wiki/File:EingangswiderstandAusgangswiderstandA.svg}}
	  \bibitem{stehwelle}
	    By Pyrometer (Own work),
	    \newblock{\CcImageCc{0.5} [CC0]},
	    \newblock{via Wikimedia Commons},
	    \newblock{\url{https://commons.wikimedia.org/wiki/File:Standing_wave_SWR_4_(forward,_reflected)_open.gif}}
	  \bibitem{balun}
	    By No machine-readable author provided. Wolfmankurd~commonswiki assumed (based on copyright claims),
	    \newblock{[GFDL (http://www.gnu.org/copyleft/fdl.html), CC-BY-SA-3.0 (http://creativecommons.org/licenses/by-sa/3.0/) or CC BY-SA 2.5-2.0-1.0 (http://creativecommons.org/licenses/by-sa/2.5-2.0-1.0)]},
	    \newblock{via Wikimedia Commons},
	    \newblock{\url{https://commons.wikimedia.org/wiki/File:Cdbalun2.svg}}
	  \bibitem{pl}
	    von Appaloosa (Eigenes Werk),
	    \newblock{\CcGroupBySa{0.5}{2px} [CC BY-SA 3.0 (http://creativecommons.org/licenses/by-sa/3.0) oder GFDL (http://www.gnu.org/copyleft/fdl.html)]},
	    \newblock{via Wikimedia Commons},
	    \newblock{\url{https://commons.wikimedia.org/wiki/File:UHF_PL_Connector.jpg}}
	  \bibitem{n}
	    von Swift.Hg (Eigenes Werk),
	    \newblock{\CcGroupBySa{0.5}{2px} [CC BY-SA 3.0 (http://creativecommons.org/licenses/by-sa/3.0)]}
	    \newblock{via Wikimedia Commons},
	    \newblock{\url{https://commons.wikimedia.org/wiki/File:Male_type_N_connector.jpg}}
	  \bibitem{bnc}
	    By Kaback (Own work),
	    \newblock{\CcGroupBySa{0.5}{2px} [CC BY-SA 3.0 (http://creativecommons.org/licenses/by-sa/3.0)]},
	    \newblock{via Wikimedia Commons},
	    \newblock{\url{https://commons.wikimedia.org/wiki/File:BNC_50_75_Ohm.jpg}}
	  \bibitem{sma}
	    von Peter Trieb / de:Benutzer:TheNoOne,
	    \newblock{\CcGroupPd{0.5} [Public domain]},
	    \newblock{via Wikimedia Commons},
	    \newblock{\url{https://commons.wikimedia.org/wiki/File:Reverse_sma_stecker.jpg}}
