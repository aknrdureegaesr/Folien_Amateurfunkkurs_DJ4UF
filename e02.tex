...
\begin{frame}
	...
	\begin{center}
	    ...
	    \includegraphics[width=.7\textwidth]{e02/Current_notation.png}\\
...
\begin{frame}
    ...
    \begin{center}
        ...
        \includegraphics[width=.5\textwidth]{e02/reiheAmpare.png}
      \end{center}
\end{frame}

\begin{frame}
    \frametitle{Wie sollte gemessen werden?}
        \includegraphics[width=.8\textwidth]{e02/stromSpannung.png}
        \footnote{\tiny Fragenkatalog Bundesnetzargentur Klasse E TJ201}
\end{frame}
