...
\begin{frame}
    ...
    \begin{center}
        \only<1>{\includegraphics[width=.85\textwidth,height=.85\textheight,keepaspectratio]{e16/fldigi_opconf.png}}
        \only<2>{\includegraphics[width=.85\textwidth,height=.85\textheight,keepaspectratio]{e16/fldigi_audioconf.png}}
    \end{center}
