  ...
  \frametitle{Beispiele}
    ...
    \begin{itemize}
       ...
       \item \textbf{MM/}DK\O CCC
             \only<2>{$\rightarrow$ Clubstation DK\O CCC zu Besuch in Schottland\footnote{unklare Regelung, ob das erlaubt ist, da eine Clubstation nur für einen festen Betriebsort in Deutschland ausgestellt wird}}
