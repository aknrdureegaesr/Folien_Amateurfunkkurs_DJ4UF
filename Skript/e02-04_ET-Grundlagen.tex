...
\aufgabentext{
	...
	\item[5] \emph{\textbf{TC105-107}} Ordne den folgenden Schaltzeichen die Bezeichnungen LDR, PTC, NTC und VDR zu.\\
		\includegraphics[scale=0.21]{Bild04.png}
...
ist die Teilspannung $U_2$?\\ \includegraphics[scale=0.1]{Spannungsteiler.png}}%Frage
{$2,20V$}%A
{$2,64V$}%B
{$10,0V$}%C
{$1,22V$}%D
...
\includegraphics[scale=0.3]{Parallelschaltung.png}}%Frage
{$250\Omega$}%A
{$500\Omega$}%B
{$1k\Omega$}%C
{$2k\Omega$}%D
...
\begin{enumerate}
  \item Vorstellung des Kurskofferskonzepts (kurz) und der Werkzeugtaschen
