...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{Hausanschlussverstärker des Kabelfernsehen mit Blockschaltbildern}{DC4LW (eigene Aufnahme)}{http://dc4lw.de}{}
    \end{figure}
  \end{center}
\end{frame}
  ...
  \begin{columns}
    ...
    \begin{center}
      \begin{figure}
        ...
        \attribcaption{TG103}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
      \end{figure}
    \end{center}
    \column{.45\textwidth}
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{TG102}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{TG226}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{TG106}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{TG101}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      \includegraphics[width=0.8\textwidth,height=.35\textheight,keepaspectratio]{a13/TD701.png}
      \attribcaption{TD701}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
  ...
  \begin{itemize}
    ...
    \item Mikroprozessor steuert Teilerfunktion ``:n'' für die Ausgangsfrequenz
...
\begin{frame}
  ...
  \begin{columns}[c]
    ...
    \begin{figure}
      ...
      \attribcaption{TG110}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
    \column{.35\textwidth}
    \begin{itemize}
      \item Nur ein CO
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{TF209b}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
\end{frame}
\begin{frame}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{TF205b}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{TF213}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{TF204}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \begin{figure}
      ...
      \attribcaption{TF209}{BNetzA}{https://www.bundesnetzagentur.de/amateurfunk/}{}
    \end{figure}
  \end{center}
