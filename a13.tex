...
\begin{frame}
    ...
    Welches Band mit VFO auf $3,51 MHz$? \only<2>{14,04 MHz (20m)}
...
\begin{frame}
    ...
    \only<2>{\vspace{2em} Ein Quarzfilter als Seitenbandsperre.}
...
\begin{frame}
    ...
    eingestellt und VCO2 auf 6 MHz eingerastet ist? \only<2>{3,651 MHz}
...
\begin{frame}
    ...
    \only<2>{124,2 MHz - deshalb Vorselektion wichtig}
...
\begin{frame}
    ...
    \only<2>{Der VFO muss bei 38,70 MHz und der CO bei 11,16 MHz schwingen.}
