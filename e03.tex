...
\begin{frame}
	...
	\begin{center}
		\scalebox{2.5}{$\eta = \frac{Wirkleistung}{Gesamtleistung}$}
	\end{center}
\end{frame}

\section*{Elektrizität nach M.C. Escher}
\begin{frame}
...
\begin{thebibliography}{}
  ...
  \bibitem{wp}    Wikipedia DE: \\
    ...
    \bibitem{dreieck}  Abbildung \ref{fig_dreieck}: Das Ohm'sche Dreieck\\
	    \url{https://commons.wikimedia.org/wiki/File:Ohm's_law_triangle.PNG}\\
	\bibitem{escher}  Abbildung \ref{fig_escher}: Elektrizität nach M.C. Escher\\
