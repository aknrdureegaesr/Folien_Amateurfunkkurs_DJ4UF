...
% TODO Wiederholungspart eindeutiger markieren und schnell abarbeiten

\input{texdata/preamble}
\subtitle{Technik A08: \\
  Das elektromagnetische Feld \\[2em]}
\date{Stand 18.05.2017}
...
\begin{frame}
  ...
  % Die Dateinamen sind bereits aus WikiCommons falsch
  % Korrekturen nachgeschlagen in 'Stöcker: Taschenbuch der Physik. 3. Auflage 1998. Verlag Harri Deutsch.'
  \begin{columns}[t]
    \column{.49\textwidth}
    \begin{center}
      \begin{figure}
        \includegraphics[width=1\textwidth,height=.6\textheight,keepaspectratio]{a08/Hard_hysteresis_de.png}
        \attribcaption{Magnetisch weicher Werkstoff: Zur Ummagnetisierung wird wenig Arbeit benötigt.}{Emeko}{https://commons.wikimedia.org/wiki/File:Hard_hysteresis_de.svg}{\ccpd}
      \end{figure}
    \end{center}
    \column{.49\textwidth}
    \begin{center}
      \begin{figure}
        ...
        \attribcaption{Magnetisch harter Werkstoff: Zur Ummagnetisierung ist viel Arbeit notwendig.}{Emeko}{https://commons.wikimedia.org/wiki/File:Soft_hysteresis_welded.svg}{\ccpd}
      \end{figure}
    \end{center}
  \end{columns}
\end{frame}
