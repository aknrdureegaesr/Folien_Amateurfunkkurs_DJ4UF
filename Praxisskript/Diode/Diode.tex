...
\begin{figure}[H]
	\centering
	\subfigure[vi]{\input{Diode/Schaltungen/Diode_Schaltzeichen}}\\
	\subfigure[vii]{\includegraphics[scale=0.5]{Diode/Bilder/Kennlinie_Diode.png}}\\
	\subfigure[viii]{\input{Diode/Schaltungen/Z-Diode_Schaltzeichen}}\\
	\subfigure[iv]{\input{Diode/Schaltungen/Z-Diode_Stabilisierung}}
\end{figure}
}