...
%    \end{center}
  ...
  \begin{center}
    \begin{figure}
      ...
      \only<13>{\includegraphics[width=\textwidth,height=.45\textheight,keepaspectratio]{e08/Dipolentstehung-12.png}}
      \only<14>{\includegraphics[width=\textwidth,height=.45\textheight,keepaspectratio]{e08/Dipolentstehung-13.png}}
      \only<15>{\includegraphics[width=\textwidth,height=.45\textheight,keepaspectratio]{e08/Dipolentstehung-14.png}}
      \only<16>{\includegraphics[width=\textwidth,height=.45\textheight,keepaspectratio]{e08/Dipolentstehung-15.png}}
      \only<17>{\includegraphics[width=\textwidth,height=.45\textheight,keepaspectratio]{e08/Dipolentstehung-16.png}}
      \only<18>{\includegraphics[width=\textwidth,height=.45\textheight,keepaspectratio]{e08/Dipolentstehung-17.png}}
      \only<19>{\includegraphics[width=\textwidth,height=.45\textheight,keepaspectratio]{e08/Dipolentstehung-18.png}}
      \only<20>{\includegraphics[width=\textwidth,height=.45\textheight,keepaspectratio]{e08/Dipolentstehung-19.png}}
      \only<21>{\includegraphics[width=\textwidth,height=.45\textheight,keepaspectratio]{e08/Dipolentstehung-20.png}}
      \only<22>{\includegraphics[width=\textwidth,height=.45\textheight,keepaspectratio]{e08/Dipolentstehung-21.png}}
...
\begin{frame}
    ...
    \begin{center}
        \begin{minipage}{0.45\textwidth}
            ...
            \only<1>{\includegraphics[width=\textwidth,height=.6\textheight,keepaspectratio]{e08/Dipole_xmting_antenna_animation_4_408x318x150ms-0.png}\\}
            \only<2>{\includegraphics[width=\textwidth,height=.6\textheight,keepaspectratio]{e08/Dipole_xmting_antenna_animation_4_408x318x150ms-1.png}\\}
            \only<3>{\includegraphics[width=\textwidth,height=.6\textheight,keepaspectratio]{e08/Dipole_xmting_antenna_animation_4_408x318x150ms-2.png}\\}
            \only<4>{\includegraphics[width=\textwidth,height=.6\textheight,keepaspectratio]{e08/Dipole_xmting_antenna_animation_4_408x318x150ms-3.png}\\}
            \only<5>{\includegraphics[width=\textwidth,height=.6\textheight,keepaspectratio]{e08/Dipole_xmting_antenna_animation_4_408x318x150ms-4.png}\\}
            \only<6>{\includegraphics[width=\textwidth,height=.6\textheight,keepaspectratio]{e08/Dipole_xmting_antenna_animation_4_408x318x150ms-5.png}\\}
            \only<7>{\includegraphics[width=\textwidth,height=.6\textheight,keepaspectratio]{e08/Dipole_xmting_antenna_animation_4_408x318x150ms-6.png}\\}
            \only<8>{\includegraphics[width=\textwidth,height=.6\textheight,keepaspectratio]{e08/Dipole_xmting_antenna_animation_4_408x318x150ms-7.png}\\}
