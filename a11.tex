...
\begin{frame}
  ...
  \only<3>{\vspace{3em}\Large Merke: $n$-te Oberwelle = $n+1$-te Harmonische}
...
% TODO AM besser erklären -- die meisten Kursteilnehmer denken, durch die Frequenzänderung bei SSB sei es FM
% Dabei auch Wasserfall erklären und wie der Ausschlag bei SSB zustande kommt bzw. die Stärke des Signals
% Am besten von allem ein 3D-Video haben
...
% TODO Hub besser erklären mit passenderem Bild oder Video
