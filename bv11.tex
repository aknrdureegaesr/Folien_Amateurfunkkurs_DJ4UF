...
\begin{frame}
    ...
    \begin{center}
        ...
        % FIXME Legende für rot und blau
    \end{center}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Mond ca. 0,5\% der Himmelsoberfläche % FIXME º ?
        \item vom Mond aus Erde auch nur ca. 2\% % FIXME º ?
...
\begin{frame}
    ...
    \begin{center}
        ...
        %\footnote{\tiny eigene Aufnahme von DC4LW bei DFØMU in Schöppingen}
