...
\textit{
  \begin{itemize}
    ...
    \item mind. zwei, aber eher mehr UHF-Funkgeräte (da am weitesten verbreitet)
      mitbringen
    \item Programmierung der CQ TU QRGs (falls notwendig): 430.200 (U0), 430.225
      (U1), 430.250 (U2), 430.275 (U3) -- Ausbilder/innen QRV U0
  \end{itemize}
}
...
Clubstation und des "`CQ TU"'-Contests.
...
besprechen und "`trocken"' zu proben. \bigskip
...
% FIXME Flowchart oder Anleitung eines QSOs (allg. & dir. Anruf) ergänzen?
