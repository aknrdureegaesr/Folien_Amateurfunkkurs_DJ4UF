...
\begin{figure}[htbp]
  ...
  \subfigure[Verbindungen im Breadboard]{
    ...
    \includegraphics[width=0.6\textwidth]{Leeres_Board_verbindungen.jpg}
  }
  \caption{How to Breadboard \cite{afutub}} % FIXME citation
...
\begin{enumerate}
  ...
  \item Verwendet die parallele Gesamtschaltung für die weiteren Messungen
    ...
    \end{enumerate}
  \item Zusatzaufgabe: Spannungsteiler LED\\ % siehe Zusatzaufgabe unten
