...
\begin{itemize}
    ...
    \item LED
    \item 2x Widerstand (unbekannt) \loesung{47 \& FIXME $\Omega$}
\end{itemize}
...
\begin{enumerate}
  ...
  \item Ihr habt zwei Widerstände zur Verfügung. Bestimmt die Bauteilwerte
    ...
    R1 = \dots \loesung{47} $\Omega$ \\
    R2 = \dots \loesung{470} $\Omega$
  ...
  \item Verwendet die parallele Gesamtschaltung für die weiteren Messungen
    \begin{enumerate}
      \item Messt die Einzelströme durch die Widerstände! Rechnet nach! \\
        \loesung{FIXME: Musterlösung \& Wirkungsgrad schlecht}
      \item Messt die notwendigen Spannungen um die Leistungsaufnahme der
        ...
        \loesung{FIXME: Musterlösung \& Wirkungsgrad schlecht}
    \end{enumerate}
  \item TODO: Zusatzaufgabe: Spannungsteiler LED
\end{enumerate}
