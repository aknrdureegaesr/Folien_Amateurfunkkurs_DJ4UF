...
\aufgabentext{
	...
	\item[1] \emph{\textbf{TB102}} Welchen Widerstand hat eine Kupferdrahtwicklung, wenn der verwendete Draht eine Länge von 1,8 m und einen Durchmesser von 0,2 mm hat
		...
		\item[C] 5,6 $\Omega$
		\item[D] 56 $\Omega$
		\loesung{Lösung: B \hspace{3em} $R = \rho \frac{l}{A}$ mit $A = \pi r^2$}
		\end{enumerate}
	\end{enumerate}
}
...
{1,22 $\Omega$}%C
{12,15 $\Omega$}%D
{C \hspace{3em} $R_{innen} = \frac{\Delta U}{\Delta I} = \frac{1,1 V}{0,9 A}$}%Lösung
...
{C \hspace{3em} $\eta_\% = \frac{P_{ab}}{P_{zu}} \cdot 100\%
                 ...
                 = \frac{12,5 V \cdot 1 A}{13,5 V \cdot 1 A} \cdot 100\%$}%Lösung
