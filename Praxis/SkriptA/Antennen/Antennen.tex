...
\loesung{
    Bild A Langdrahtantenne oder Fuchs-Antenne
    Bild B Zeppelin-Antenne
    Bild C G5RV-Antenne
    Bild D Windom-Antenne
    Bild E Fuchs-Antenne
    Bild F Trap-Dipol
}
\end{enumerate}
...
\mucho{6}{TH231}
{Eine Langdrahtantenne mit einer senkrechten Speiseleitung in der Nähe eines Hauses}%Frage
{erzeugt keine unerwünschten Signale in horizontal verlegten Stromleitungen.}%A
{induziert keine Störungen in horizontalen Antennen.}%B
{kann unerwünschte Signale in TV-Koaxialkabel induzieren.}%C
{erzeugt ein Summen im Stromversorgungsnetz.}%D
{C}%Lösung