...
% FIXME Aufgaben so generisch gestaltet, dass es auch mit einfachen Mitteln
% umsetzbar ist. Z.B. Messung mit den RTL-Dongles.
% FIXME Es fehlt eine Auswertung der Ergebnisse
% TODO ggf. Sprungantwort durch Bodediagramm ersetzen
...
\begin{enumerate}
    \item Das lineare Verhalten eines allgemeinen Tiefpassfilters: Welches
      ...
      \loesung{Es entsteht eine Gerade mit Offsetfehler (Realwiderstand). Hier
      würde gar nichts zu sehen sein, da der Koppelkondensator C8 DC blockt.}
% 		\begin{itemize}
...
%     		\item Die Eingangsspannung soll in $1~V$-Schritten geändert werden.
