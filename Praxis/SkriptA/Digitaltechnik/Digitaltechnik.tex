...
\begin{enumerate}
		\item[4] Ordne den Ausgangssignalen X1 - X4 in der Abbildung \ref{Grundgatter} die Grundschaltungen Und, Oder, Nand und Nor zu.\\ \loesung{X1 = Oder; X2 = Und; X3 = Xor; X4 = Nand }
	\end{enumerate}
